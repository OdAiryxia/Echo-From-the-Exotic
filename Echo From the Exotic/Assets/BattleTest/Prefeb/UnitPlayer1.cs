...
public class UnitPlayer1 : Unit
{
    ...
    private IEnumerator MoveAndAttack(Unit enemyUnit)
    {
        ...
        enemyUnit.TakeDamge(CritDamage().damage, CritDamage().isCrit);
    ...
    private IEnumerator MoveAndSkill(Unit enemyUnit)
    {
        ...
        enemyUnit.TakeDamge(CritDamage().damage * 1.5f, CritDamage().isCrit);
        ...
        {
            float areaDamage = CritDamage().damage * 0.5f;
            enemy.TakeDamge(areaDamage, CritDamage().isCrit);
        }
        yield return new WaitForSeconds(0.5f);
        yield return StartCoroutine(MoveToPosition(originalPosition));
    ...
    private IEnumerator MoveAndUltimate(Unit enemyUnit)
    {
        ...
        enemyUnit.TakeDamge(CritDamage().damage * 5f, CritDamage().isCrit);
