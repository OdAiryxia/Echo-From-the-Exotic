...
public class BattleGameManager : MonoBehaviour
{
    ...
    private void InitializeTeams()
    {
        ...
        UnitActionSystem.instance.enemyOutline = enemyTeam[0].transform.GetComponent<Outline>();
        UnitActionSystem.instance.playerOutline = playerTeam[0].transform.GetComponent<Outline>();
    ...
    void HandleUnitAction(Unit unit)
    {
        ...
        if (playerTeam.Contains(unit))
        {
            ...
            UnitActionSystem.instance.playerOutline = unit.transform.GetComponent<Outline>();
            UnitActionSystem.instance.playerOutline.OutlineMode = Outline.Mode.OutlineAll;
    ...
    void AutoEnemyAttack(Unit enemyUnit)
    {
        ...
        if (playerTeam.Count > 0)
        {
            ...
            UnitActionSystem.instance.playerOutline = target.transform.GetComponent<Outline>();
            UnitActionSystem.instance.playerOutline.OutlineMode = Outline.Mode.OutlineAll;
